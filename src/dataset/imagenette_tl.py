...
class ImagenetteFeatures(Dataset):
    '''
    Class representing the extracted features of the Imagenette dataset from a CNN.
    '''
    def __init__(self):
        '''
        Class representing the extracted features of the Imagenette dataset from a CNN.
        '''
        self.name = 'imagenettetl'
    ...
    def get_dataset(self) -> tuple:
        ...
        if missing_files:
            raise FileNotFoundError(
                ...
                "Please run the `python extract_features.py --dataset imagenette` script to generate the required files."
            )
