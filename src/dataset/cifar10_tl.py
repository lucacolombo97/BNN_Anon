...
class CIFAR10Features(Dataset):
    '''
    Class representing the extracted features of the CIFAR10 dataset from a CNN.
    '''
    def __init__(self):
        '''
        Class representing the extracted features of the CIFAR10 dataset from a CNN.
    ...
    def get_dataset(self) -> tuple:
        ...
        if missing_files:
            raise FileNotFoundError(
                ...
                "Please run the `python extract_features.py --dataset cifar10` script to generate the required files."
            )
