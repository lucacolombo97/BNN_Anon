...
class LightningClassifier(pl.LightningModule):
    def __init__(self, input_dim, layers, lr=1e-3, num_classes=10):
        """
    ...
    def configure_optimizers(self):
        """
        Define the optimizer for the model (Adam).
...
def worker(args: argparse.Namespace, n_run: int) -> None:
    ...
    # Define the model
    model = LightningClassifier(input_dim=input_dim, layers=args.layers, lr=args.lr, num_classes=num_classes)
    print(model)
